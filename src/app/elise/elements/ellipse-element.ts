...
export class EllipseElement extends ElementBase {
    ...
    */
    static create(x?: number, y?: number, rx?: number, ry?: number) {
    ...
    */
    setCenter(pointSource: string | Point) {
    ...
    */
    clone(): EllipseElement {
        const e: EllipseElement = EllipseElement.create();
        super.cloneTo(e);
        if (this._center) {
    ...
    */
    ...
    /**
      ...
      @returns This ellipse element
    */
    setLocation(point: Point): EllipseElement {
    ...
    /**
      ...
      @returns This ellipse element
    */
    setSize(size: Size): EllipseElement {
        const x = this._center.x - this.radiusX;
        const y = this._center.y - this.radiusY;
