...
export class Color {
    static Transparent = new Color(0, 255, 255, 255);
    static AliceBlue = new Color(255, 240, 248, 255);
    static AntiqueWhite = new Color(255, 250, 235, 215);
    static Aqua = new Color(255, 0, 255, 255);
    static Aquamarine = new Color(255, 127, 255, 212);
    static Azure = new Color(255, 240, 255, 255);
    static Beige = new Color(255, 245, 245, 220);
    static Bisque = new Color(255, 255, 228, 196);
    static Black = new Color(255, 0, 0, 0);
    static BlanchedAlmond = new Color(255, 255, 235, 205);
    static Blue = new Color(255, 0, 0, 255);
    static BlueViolet = new Color(255, 138, 43, 226);
    static Brown = new Color(255, 165, 42, 42);
    static BurlyWood = new Color(255, 222, 184, 135);
    static CadetBlue = new Color(255, 95, 158, 160);
    static Chartreuse = new Color(255, 127, 255, 0);
    static Chocolate = new Color(255, 210, 105, 30);
    static Coral = new Color(255, 255, 127, 80);
    static CornflowerBlue = new Color(255, 100, 149, 237);
    static Cornsilk = new Color(255, 255, 248, 220);
    static Crimson = new Color(255, 220, 20, 60);
    static Cyan = new Color(255, 0, 255, 255);
    static DarkBlue = new Color(255, 0, 0, 139);
    static DarkCyan = new Color(255, 0, 139, 139);
    static DarkGoldenrod = new Color(255, 184, 134, 11);
    static DarkGray = new Color(255, 169, 169, 169);
    static DarkGreen = new Color(255, 0, 100, 0);
    static DarkKhaki = new Color(255, 189, 183, 107);
    static DarkMagenta = new Color(255, 139, 0, 139);
    static DarkOliveGreen = new Color(255, 85, 107, 47);
    static DarkOrange = new Color(255, 255, 140, 0);
    static DarkOrchid = new Color(255, 153, 50, 204);
    static DarkRed = new Color(255, 139, 0, 0);
    static DarkSalmon = new Color(255, 233, 150, 122);
    static DarkSeaGreen = new Color(255, 143, 188, 139);
    static DarkSlateBlue = new Color(255, 72, 61, 139);
    static DarkSlateGray = new Color(255, 47, 79, 79);
    static DarkTurquoise = new Color(255, 0, 206, 209);
    static DarkViolet = new Color(255, 148, 0, 211);
    static DeepPink = new Color(255, 255, 20, 147);
    static DeepSkyBlue = new Color(255, 0, 191, 255);
    static DimGray = new Color(255, 105, 105, 105);
    static DodgerBlue = new Color(255, 30, 144, 255);
    static Firebrick = new Color(255, 178, 34, 34);
    static FloralWhite = new Color(255, 255, 250, 240);
    static ForestGreen = new Color(255, 34, 139, 34);
    static Fuchsia = new Color(255, 255, 0, 255);
    static Gainsboro = new Color(255, 220, 220, 220);
    static GhostWhite = new Color(255, 248, 248, 255);
    static Gold = new Color(255, 255, 215, 0);
    static Goldenrod = new Color(255, 218, 165, 32);
    static Gray = new Color(255, 128, 128, 128);
    static Green = new Color(255, 0, 128, 0);
    static GreenYellow = new Color(255, 173, 255, 47);
    static Honeydew = new Color(255, 240, 255, 240);
    static HotPink = new Color(255, 255, 105, 180);
    static IndianRed = new Color(255, 205, 92, 92);
    static Indigo = new Color(255, 75, 0, 130);
    static Ivory = new Color(255, 255, 255, 240);
    static Khaki = new Color(255, 240, 230, 140);
    static Lavender = new Color(255, 230, 230, 250);
    static LavenderBlush = new Color(255, 255, 240, 245);
    static LawnGreen = new Color(255, 124, 252, 0);
    static LemonChiffon = new Color(255, 255, 250, 205);
    static LightBlue = new Color(255, 173, 216, 230);
    static LightCoral = new Color(255, 240, 128, 128);
    static LightCyan = new Color(255, 224, 255, 255);
    static LightGoldenrodYellow = new Color(255, 250, 250, 210);
    static LightGray = new Color(255, 211, 211, 211);
    static LightGreen = new Color(255, 144, 238, 144);
    static LightPink = new Color(255, 255, 182, 193);
    static LightSalmon = new Color(255, 255, 160, 122);
    static LightSeaGreen = new Color(255, 32, 178, 170);
    static LightSkyBlue = new Color(255, 135, 206, 250);
    static LightSlateGray = new Color(255, 119, 136, 153);
    static LightSteelBlue = new Color(255, 176, 196, 222);
    static LightYellow = new Color(255, 255, 255, 224);
    static Lime = new Color(255, 0, 255, 0);
    static LimeGreen = new Color(255, 50, 205, 50);
    static Linen = new Color(255, 250, 240, 230);
    static Magenta = new Color(255, 255, 0, 255);
    static Maroon = new Color(255, 128, 0, 0);
    static MediumAquamarine = new Color(255, 102, 205, 170);
    static MediumBlue = new Color(255, 0, 0, 205);
    static MediumOrchid = new Color(255, 186, 85, 211);
    static MediumPurple = new Color(255, 147, 112, 219);
    static MediumSeaGreen = new Color(255, 60, 179, 113);
    static MediumSlateBlue = new Color(255, 123, 104, 238);
    static MediumSpringGreen = new Color(255, 0, 250, 154);
    static MediumTurquoise = new Color(255, 72, 209, 204);
    static MediumVioletRed = new Color(255, 199, 21, 133);
    static MidnightBlue = new Color(255, 25, 25, 112);
    static MintCream = new Color(255, 245, 255, 250);
    static MistyRose = new Color(255, 255, 228, 225);
    static Moccasin = new Color(255, 255, 228, 181);
    static NavajoWhite = new Color(255, 255, 222, 173);
    static Navy = new Color(255, 0, 0, 128);
    static OldLace = new Color(255, 253, 245, 230);
    static Olive = new Color(255, 128, 128, 0);
    static OliveDrab = new Color(255, 107, 142, 35);
    static Orange = new Color(255, 255, 165, 0);
    static OrangeRed = new Color(255, 255, 69, 0);
    static Orchid = new Color(255, 218, 112, 214);
    static PaleGoldenrod = new Color(255, 238, 232, 170);
    static PaleGreen = new Color(255, 152, 251, 152);
    static PaleTurquoise = new Color(255, 175, 238, 238);
    static PaleVioletRed = new Color(255, 219, 112, 147);
    static PapayaWhip = new Color(255, 255, 239, 213);
    static PeachPuff = new Color(255, 255, 218, 185);
    static Peru = new Color(255, 205, 133, 63);
    static Pink = new Color(255, 255, 192, 203);
    static Plum = new Color(255, 221, 160, 221);
    static PowderBlue = new Color(255, 176, 224, 230);
    static Purple = new Color(255, 128, 0, 128);
    static Red = new Color(255, 255, 0, 0);
    static RosyBrown = new Color(255, 188, 143, 143);
    static RoyalBlue = new Color(255, 65, 105, 225);
    static SaddleBrown = new Color(255, 139, 69, 19);
    static Salmon = new Color(255, 250, 128, 114);
    static SandyBrown = new Color(255, 244, 164, 96);
    static SeaGreen = new Color(255, 46, 139, 87);
    static SeaShell = new Color(255, 255, 245, 238);
    static Sienna = new Color(255, 160, 82, 45);
    static Silver = new Color(255, 192, 192, 192);
    static SkyBlue = new Color(255, 135, 206, 235);
    static SlateBlue = new Color(255, 106, 90, 205);
    static SlateGray = new Color(255, 112, 128, 144);
    static Snow = new Color(255, 255, 250, 250);
    static SpringGreen = new Color(255, 0, 255, 127);
    static SteelBlue = new Color(255, 70, 130, 180);
    static Tan = new Color(255, 210, 180, 140);
    static Teal = new Color(255, 0, 128, 128);
    static Thistle = new Color(255, 216, 191, 216);
    static Tomato = new Color(255, 255, 99, 71);
    static Turquoise = new Color(255, 64, 224, 208);
    static Violet = new Color(255, 238, 130, 238);
    static Wheat = new Color(255, 245, 222, 179);
    static White = new Color(255, 255, 255, 255);
    static WhiteSmoke = new Color(255, 245, 245, 245);
    static Yellow = new Color(255, 255, 255, 0);
    static YellowGreen = new Color(255, 154, 205, 50);
    ...
    */
    ...
    @method Elise.Drawing.Color#toHexString
