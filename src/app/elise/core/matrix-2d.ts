export class Matrix2D {
    static IDENTITY: Matrix2D = new Matrix2D(1, 0, 0, 1, 0, 0);

    /**
      Matrix factory function
      @method Elise.Drawing.Matrix2D#create
      @returns New matrix
    */
    static create(m11: number, m12: number, m21: number, m22: number, offsetX: number, offsetY: number): Matrix2D {
        return new Matrix2D(m11, m12, m21, m22, offsetX, offsetY);
    }

    /**
      Multiplies two matrices
      @method Elise.Drawing.Matrix2D#multiply
      @param a - Matrix A
      @param b - Matrix B
    ...
    */
    ...
    /**
      ...
      @method Elise.Drawing.Matrix2D#cloneFrom
    ...
    */
    ...
    /**
      ...
      @method Elise.Drawing.Matrix2D#translate
    ...
    */
    ...
    /**
      ...
      @method Elise.Drawing.Matrix2D#scale
    ...
    */
    ...
    /**
      ...
      @method Elise.Drawing.Matrix2D#rotate
