...
export class DesignRenderer {
    ...
    */
    ...
    /**
      ...
      @method Elise.Drawing.Design.DesignRenderer#renderToContext
    ...
    */
    renderImageElement(c: CanvasRenderingContext2D, image: ImageElement) {
        const model = image.model;
        const resource = image.model.resourceManager.get(image.source) as BitmapResource;
    ...
    */
    renderSpriteElement(c: CanvasRenderingContext2D, sprite: SpriteElement) {
        const model = sprite.model;
        const frame = sprite.frames[sprite.frameIndex];
        const resource = sprite.model.resourceManager.get(frame.source) as BitmapResource;
    ...
    */
    renderRectangleElement(c: CanvasRenderingContext2D, rectangle: RectangleElement) {
    ...
    */
    renderLineElement(c: CanvasRenderingContext2D, line: LineElement) {
        ...
        if (this.controller.isMovingPoint && this.controller.isSelected(line)) {
    ...
    */
    renderPolylineElement(c: CanvasRenderingContext2D, polyline: PolylineElement) {
    ...
    */
    renderPolygonElement(c: CanvasRenderingContext2D, polygon: PolygonElement) {
    ...
    */
    renderPathElement(c: CanvasRenderingContext2D, pathElement: PathElement) {
    ...
    */
    renderEllipseElement(c: CanvasRenderingContext2D, ellipse: EllipseElement) {
    ...
    */
    renderTextElement(c: CanvasRenderingContext2D, textElement: TextElement) {
    ...
    */
    renderModelElement(c: CanvasRenderingContext2D, modelElement: ModelElement) {
        ...
        const resource = modelElement.model.resourceManager.get(modelElement.source) as ModelResource;
