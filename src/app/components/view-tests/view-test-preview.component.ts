...
@Component({
    ...
    selector: 'app-view-test-preview',
    templateUrl: './view-test-preview.component.html',
    styleUrls: ['./view-test-preview.component.scss']
})
export class ViewTestPreviewComponent implements AfterViewInit, OnDestroy {
    ...
    @Input({ required: true }) test: ViewSample;

    model: Model | null = null;
    background: 'grid' | 'black' | 'white' | 'gray' = 'gray';
    timerEnabled = false;
    scale = 1;
    loadFailed = false;
    isLoaded = false;
    ...
    private loadPreview(): void {
        ...
        try {
            ...
            viewer.model.prepareResources(null, (result) => {
                ...
                this.timerEnabled = viewer.timerEnabled;
    ...
    private createPreviewViewer(): ISampleViewer {
        return {
