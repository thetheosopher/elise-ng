...
elise.rectangle(10, 210, 100, 100).setFill('#30000000').addTo(model);
elise.rectangle(110, 210, 100, 100).setFill('#80000000').addTo(model);
elise.rectangle(210, 210, 100, 100).setFill('#B0000000').addTo(model);
return model;
